...
public class RangoFechas {
    ...
    /**
     * Retorna true si la fecha indicada está en el rango de fechas, false de lo contrario
    ...
    public boolean contieneFecha(String fecha) {
        ...
        return !fechaLocal.isBefore(fechaInicio) && !fechaLocal.isAfter(fechaFinal);
    }
